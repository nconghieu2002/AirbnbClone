...
function PhotosUploader({ addedPhotos, onChange }) {
    ...
    const selectAsMainPhoto = (e, filename) => {
        e.preventDefault();
        const newAddedPhoto = [...addedPhotos.filter((photo) => photo !== filename)];
        onChange([filename, ...newAddedPhoto]);
    };
            ...
            <div className="mt-2 gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                {addedPhotos.length > 0 &&
                    addedPhotos.map((link, value) => (
                        <div className="relative h-36 flex" key={value}>
                            <img
                            ...
                            <button
                                ...
                                className="absolute bottom-1 right-1 p-1 text-white bg-black bg-opacity-50 rounded-full cursor-pointer"
                            >
                                <svg
                            ...
                            <button
                                ...
                                className="absolute bottom-1 left-1 p-1 text-white bg-black bg-opacity-50 rounded-full cursor-pointer"
                            >
                                {link === addedPhotos[0] ? (
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
